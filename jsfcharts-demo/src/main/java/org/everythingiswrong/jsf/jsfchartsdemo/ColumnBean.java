...
//	private Integer[] year2008 = new Integer[] {973, 914, 4054, 732, 34};
	...
	private String[] categorie = new String[] {"Jan", "Feb", "Mar", "Apr", "May", "Jun"};
	private Double[] tokyo = new Double[] {49.9, 71.5, 106.4, 129.2, 144.0, 176.0};
	private Double[] newYork = new Double[] {83.6, 78.8, 98.5, 93.4, 106.0, 84.5};
	private Double[] london = new Double[] {48.9, 38.8, 39.3, 41.4, 47.0, 48.3};
	private Double[] berlin = new Double[] {42.4, 33.2, 34.5, 39.7, 52.6, 75.5};
...
//            1447162, 1005011, 330870, 130632, 21208};
	...
	public void setTokyo(Double[] tokyo) {
		this.tokyo = tokyo;
	}
	...
	public void setBerlin(Double[] berlin) {
		this.berlin = berlin;
	}
